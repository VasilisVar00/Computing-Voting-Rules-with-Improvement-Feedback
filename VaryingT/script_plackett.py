...
phi = 2/3 # parameters of mallows model
...
N = 500
T = [1, 4, 7, 10, 13]
alphas = [0.6090889288520809, 0.26106513205273585, 0.32560503207274116, 0.48373092549278285, 0.9966938322681743, 0.6540981787032101, 0.5344141400706653, 0.8839724420057306, 0.7476912624386994, 0.7304445240713902, 0.1566178037820284, 0.08062654559496374, 0.7325764901696482, 0.6984963901271382, 0.7083578780596743, 0.35269526312966903, 0.9425169499934516, 0.15161085633460314, 0.3704870090571961, 0.5441132775035619]
...
with open(f"results_plackett.csv", "a", newline= '') as file:
        ...
        for mode in modes:
            if mode == "pairwise":
                if rule == "plurality":
                    ...
                    tid = T.index(t)
                    with open("results_plackett.csv", "a", newline='') as file:
                        writer = csv.writer(file)
